...
{
    public class ProductCategoryRepo :Repository<ProductCategory>, IProductCategories
    {
        private readonly ApplicationDbContext _context;
        public ProductCategoryRepo(ApplicationDbContext applicationDbContext) : base(applicationDbContext)
        {
